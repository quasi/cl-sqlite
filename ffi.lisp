(defpackage :inquisitio.ffi
  (:nicknames :sqlite-ffi)
  (:use :cl :cffi)
  (:export :error-code
           :p-sqlite3
           :sqlite3-open
...
(defctype x-func :pointer)
(defctype x-step :pointer)
(defctype x-final :pointer)
(defctype x-destroy :pointer)
